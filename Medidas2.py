...
document_0 = "Patricia Bullrich, sobre el desalojo de PepsiCo El gobierno bonaerense hizo lo que tenía que hacer y actuó"
document_1 = "Bloquearon las vías del tren Sarmiento en solidaridad con los trabajadores de PepsiCo"
document_2 = "Pese a su condena por corrupción, Lula ratificó que será candidato a presidente en 2018"
document_3 = "Marea humana desesperada por los descuentos Filas desde la madrugada hasta la noche en supermercados por la necesidad de ahorrar hasta 1500 pesos"
document_4 = "Se despeja el último obstáculo para que la causa Ciccone sea elevada a juicio oral"
document_5 = "Corrupción en Brasil Lula da Silva se defiende: Hay un intento de sacarme del juego político"
document_6 = "Locura y colas en los supermercados por el descuento del cincuenta porciento en las compras"
...
#print 'matching similarity', matching_similarity(tokenized_documents[4], tokenized_documents[4])
...
#print 'dice similarity', dice_similarity(tokenized_documents[4], tokenized_documents[4])
...
#print tfidf_onedoc(all_documents, 0)
...
print 'cosine similarity my_tfidf', cosine_similarity(tfidf_representation[0], tfidf_representation[4])
